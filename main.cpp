...
public:
    SingleStageCore(string ioDir, InsMem &imem, DataMem &dmem) : Core(ioDir + "\\SS_", imem, dmem),
...
public:
    ...
    FiveStageCore(string ioDir, InsMem &imem, DataMem &dmem) : Core(ioDir + "\\FS_", imem, dmem),
